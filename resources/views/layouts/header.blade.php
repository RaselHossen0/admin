<div class="navbar-header">
    <a class="navbar-brand" href="<?php echo URL::to('/'); ?>">
        <b>
            <img src="https://firebasestorage.googleapis.com/v0/b/foddie-ddd88.appspot.com/o/images%2FWhatsApp%20Image%202023-09-01%20at%206_1693572151683.10?alt=media&token=65db6cfd-e69b-42f3-a910-9ed3e69a0cce" alt="homepage" class="dark-logo" width="200px !important;" id="logo_web">
